...
import com.neelnetwork.consensus.GeneratingBalanceProvider
...
import com.neelnetwork.transaction.{TransactionFactory, ValidationError}
  ...
  @ApiImplicitParams(
    Array(
      ...
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.neelnetwork.api.http.SignedMessage",
        defaultValue =
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.neelnetwork.api.http.DataRequest",
        defaultValue =
