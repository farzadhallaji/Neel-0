...
import com.neelnetwork.api.http.CompositeHttpService
import com.neelnetwork.db._
import com.neelnetwork.matcher.api.{MatcherApiRoute, OrderBookSnapshotHttpCache}
import com.neelnetwork.matcher.market.OrderBookActor.MarketStatus
import com.neelnetwork.matcher.market.{MatcherActor, MatcherTransactionWriter, OrderHistoryActor}
import com.neelnetwork.matcher.model.{ExchangeTransactionCreator, OrderBook, OrderValidator}
...
object Matcher extends ScorexLogging {
  def apply(actorSystem: ActorSystem,
            ...
            allChannels: ChannelGroup,
            blockchain: Blockchain,
            settings: NeelSettings): Option[Matcher] =
    try {
      val privateKey = (for {
