...
import com.neelnetwork.state.diffs.{ENOUGH_AMT, assertDiffAndState}
...
import com.neelnetwork.utils.{Base58, compilerContext}
  ...
  val preconditionsAndPayments = for {
    ...
    untypedScript <- Gen
      ...
      .map {
        ...
        case 2 => scriptWithNeelFunctions(dataTransaction, transfer)
