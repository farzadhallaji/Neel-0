...
import com.neelnetwork.matcher.market.MatcherActor.{GetMarkets, MarketData}
import com.neelnetwork.matcher.market.OrderBookActor._
import com.neelnetwork.matcher.market.OrderHistoryActor
import com.neelnetwork.matcher.model._
import com.neelnetwork.metrics.TimerExt
import com.neelnetwork.settings.NeelSettings
import com.neelnetwork.state.ByteStr
import com.neelnetwork.transaction.AssetAcc
import com.neelnetwork.transaction.assets.exchange.OrderJson._
...
case class MatcherApiRoute(assetPairBuilder: AssetPairBuilder,
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(name = "amountAsset", value = "Amount Asset Id in Pair, or 'NEEL'", dataType = "string", paramType = "path"),
      new ApiImplicitParam(name = "priceAsset", value = "Price Asset Id in Pair, or 'NEEL'", dataType = "string", paramType = "path"),
  ...
  @ApiImplicitParams(
    Array(
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.neelnetwork.transaction.assets.exchange.Order"
      )
    ))
  ...
  @ApiImplicitParams(
    Array(
      ...
      new ApiImplicitParam(
        ...
        required = true,
        paramType = "body",
        dataType = "com.neelnetwork.matcher.api.CancelOrderRequest"
      )
    ))
