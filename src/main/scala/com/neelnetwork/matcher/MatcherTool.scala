...
import com.neelnetwork.database._
import com.neelnetwork.db.openDB
import com.neelnetwork.matcher.api.DBUtils
import com.neelnetwork.matcher.market.{MatcherActor, OrderBookActor}
import com.neelnetwork.matcher.model.{LimitOrder, OrderBook}
...
object MatcherTool extends ScorexLogging {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val settings     = NeelSettings.fromConfig(actualConfig)
