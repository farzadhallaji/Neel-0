...
class SetScriptTransactionSpecification extends GenericTransactionSpecification[SetScriptTransaction] {
  ...
  def transactionParser: com.neelnetwork.transaction.TransactionParserFor[SetScriptTransaction] = SetScriptTransaction
  ...
  def generator: Gen[((Seq[com.neelnetwork.transaction.Transaction], SetScriptTransaction))] = setScriptTransactionGen.map(t => (Seq(), t))
