...
import cats.Show
import com.neelnetwork.generator.NarrowTransactionGenerator.Settings
import com.neelnetwork.state.DataEntry.{MaxValueSize, Type}
import com.neelnetwork.state.{BinaryDataEntry, BooleanDataEntry, ByteStr, EitherExt2, IntegerDataEntry, StringDataEntry}
import org.slf4j.LoggerFactory
import com.neelnetwork.account.{Alias, PrivateKeyAccount}
...
import com.neelnetwork.transaction.lease.{LeaseCancelTransaction, LeaseCancelTransactionV1, LeaseTransactionV1}
  ...
  def generate(n: Int): Seq[Transaction] = {
    ...
    val tradeAssetIssue = IssueTransactionV1
      .selfSigned(
        ...
        "TRADE".getBytes,
        "Neel DEX is the best exchange ever".getBytes,
        100000000,
        2,
        reissuable = false,
