...
import com.neelnetwork.state.patch.{CancelAllLeases, CancelInvalidLeaseIn, CancelLeaseOverflow}
...
import com.neelnetwork.transaction.ValidationError.ActivationError
import com.neelnetwork.transaction.{Transaction, ValidationError}
            ...
            balance = portfolio.balance +
              portfolio.assets.map {
                case (assetId, assetFee) =>
                  ...
                  Sponsorship.toNeel(assetFee, baseFee)
              }.sum)
        else portfolio
