...
import com.neelnetwork.consensus.FairPoSCalculator
import com.neelnetwork.crypto
import com.neelnetwork.it.api.AsyncNetworkApi.NodeAsyncNetworkApi
import com.neelnetwork.it.api.SyncHttpApi._
import com.neelnetwork.it.transactions.NodesFromDocker
import com.neelnetwork.it.{NodeConfigs, WaitForHeight2}
...
class PoSSuite extends FunSuite with Matchers with NodesFromDocker with WaitForHeight2 with CancelAfterFailure {
  ...
  override protected def nodeConfigs: Seq[Config] =
    NodeConfigs.newBuilder
      ...
      .withDefault(3)
      .withSpecial(_.raw("neel.miner.enable = yes"))
      .buildNonConflicting()
