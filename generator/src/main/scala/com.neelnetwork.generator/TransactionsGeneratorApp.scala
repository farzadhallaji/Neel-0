...
import com.neelnetwork.generator.Preconditions.{PGenSettings, UniverseHolder}
import com.neelnetwork.generator.cli.ScoptImplicits
import com.neelnetwork.generator.config.FicusImplicits
import com.neelnetwork.generator.utils.Universe
...
import com.neelnetwork.utils.{LoggerFacade, NTP}
...
object TransactionsGeneratorApp extends App with ScoptImplicits with FicusImplicits with EnumerationReader {
  ...
  // IDEA bugs
  implicit val inetSocketAddressReader        = com.neelnetwork.settings.inetSocketAddressReader
