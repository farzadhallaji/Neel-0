...
import com.neelnetwork.api.http.{ApiRoute, DiscontinuedApi}
...
@Api(value = "neel")
@Deprecated
case class NeelApiRoute(settings: RestAPISettings, wallet: Wallet, utx: UtxPool, allChannels: ChannelGroup, time: Time)
    extends ApiRoute
    with BroadcastRoute {

  override lazy val route = pathPrefix("neel") {
