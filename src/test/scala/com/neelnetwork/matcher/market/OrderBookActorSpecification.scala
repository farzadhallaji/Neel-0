...
import com.neelnetwork.NTPTime
import com.neelnetwork.OrderOps._
import com.neelnetwork.matcher.MatcherTestData
import com.neelnetwork.matcher.api.{OrderAccepted, OrderCanceled}
import com.neelnetwork.matcher.fixtures.RestartableActor
import com.neelnetwork.matcher.fixtures.RestartableActor.RestartActor
...
import com.neelnetwork.state.{ByteStr, Diff}
import com.neelnetwork.transaction._
import com.neelnetwork.transaction.assets.exchange.{AssetPair, ExchangeTransaction, Order}
...
class OrderBookActorSpecification extends MatcherSpec("OrderBookActor") with NTPTime with ImplicitSender with MatcherTestData with PathMockFactory {
  ...
  "OrderBookActor" should {
    ...
    "buy small amount of pricey asset" in obcTest { (_, actor) =>
      val p = AssetPair(Some(ByteStr("NEEL".getBytes)), Some(ByteStr("USD".getBytes)))
