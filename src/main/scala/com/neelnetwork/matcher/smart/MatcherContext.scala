...
import com.neelnetwork.lang.v1.compiler.Terms.{CONST_LONG, CaseObj}
import com.neelnetwork.lang.v1.compiler.Types.FINAL
import com.neelnetwork.lang.v1.evaluator.FunctionIds._
import com.neelnetwork.lang.v1.evaluator.ctx._
import com.neelnetwork.lang.v1.evaluator.ctx.impl.neel.Bindings.{ordType, orderObject}
import com.neelnetwork.lang.v1.evaluator.ctx.impl.neel.Types._
import com.neelnetwork.lang.v1.evaluator.ctx.impl.{CryptoContext, PureContext, _}
import com.neelnetwork.lang.v1.traits.domain.OrdType
...
import com.neelnetwork.transaction.smart.RealTransactionWrapper
...
object MatcherContext {
  ...
  def build(version: ScriptVersion, nByte: Byte, in: Coeval[Order], proofsEnabled: Boolean): EvaluationContext = {
    ...
    val matcherVars: Map[String, ((FINAL, String), LazyVal)] = Map(
      ("height", ((com.neelnetwork.lang.v1.compiler.Types.LONG, "undefined height placeholder"), LazyVal(EitherT(heightCoeval)))),
    ...
    val neelBalanceF: BaseFunction         = inaccessibleUserFunction("neelBalanceF")
