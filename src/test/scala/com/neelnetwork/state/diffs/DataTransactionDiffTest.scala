...
import com.neelnetwork.state.{BinaryDataEntry, BooleanDataEntry, ByteStr, DataEntry, EitherExt2, IntegerDataEntry}
...
import com.neelnetwork.transaction.{DataTransaction, GenesisTransaction}
