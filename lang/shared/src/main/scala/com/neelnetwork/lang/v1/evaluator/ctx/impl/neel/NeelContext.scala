package com.neelnetwork.lang.v1.evaluator.ctx.impl.neel

import cats.data.EitherT
import cats.implicits._
import com.neelnetwork.lang.ScriptVersion
import com.neelnetwork.lang.v1.compiler.Terms._
import com.neelnetwork.lang.v1.compiler.Types.{BYTEVECTOR, LONG, STRING, _}
import com.neelnetwork.lang.v1.evaluator.FunctionIds._
import com.neelnetwork.lang.v1.evaluator.ctx._
import com.neelnetwork.lang.v1.evaluator.ctx.impl.{EnvironmentFunctions, PureContext, _}
import com.neelnetwork.lang.v1.traits._
import com.neelnetwork.lang.v1.traits.domain.{OrdType, Recipient}
import com.neelnetwork.lang.v1.{CTX, FunctionHeader}
...
object NeelContext {
  ...
  import Bindings._
  import Types._
  import com.neelnetwork.lang.v1.evaluator.ctx.impl.converters._
  ...
  def build(version: ScriptVersion, env: Environment, isTokenContext: Boolean): CTX = {
    ...
    val txByIdF: BaseFunction = {
      val returnType = com.neelnetwork.lang.v1.compiler.Types.UNION.create(UNIT +: anyTransactionType.l)
    ...
    val assetBalanceF: BaseFunction =
      NativeFunction(
        ...
        ("addressOrAlias", addressOrAliasType, "account"),
        ("assetId", UNION(UNIT, BYTEVECTOR), "assetId (NEEL if none)")
      ) {
    ...
    val neelBalanceF: UserFunction =
      UserFunction("neelBalance", LONG, "get NEEL balanse for account", ("@addressOrAlias", addressOrAliasType, "account")) {
    ...
    val commonVars = Map(
      ("height", ((com.neelnetwork.lang.v1.compiler.Types.LONG, "Current blockchain height"), LazyVal(EitherT(heightCoeval)))),
    ...
    val types = buildNeelTypes(proofsEnabled)
