package com.neelnetwork.network

import java.net.{InetAddress, InetSocketAddress}
import java.util

import com.google.common.primitives.{Bytes, Ints}
import com.neelnetwork.mining.Miner.MaxTransactionsPerMicroblock
...
import com.neelnetwork.network.message.Message._
import com.neelnetwork.network.message._
import com.neelnetwork.transaction.{Transaction, TransactionParsers}
...
object TransactionSpec extends MessageSpec[Transaction] {
  ...
  // Modeled after Data Transaction https://neelnetwork.atlassian.net/wiki/spaces/MAIN/pages/119734321/Data+Transaction
