...
import com.neelnetwork.settings.{BlockchainSettings, TestFunctionalitySettings, NeelSettings}
...
package object history {
  ...
  val MicroblocksActivatedAt0NeelSettings: NeelSettings = settings.copy(blockchainSettings = MicroblocksActivatedAt0BlockchainSettings)

  val DefaultNeelSettings: NeelSettings = settings.copy(blockchainSettings = DefaultBlockchainSettings,
