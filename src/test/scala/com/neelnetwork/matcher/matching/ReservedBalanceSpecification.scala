package com.neelnetwork.matcher.matching
...
import com.neelnetwork.matcher.{AssetPairDecimals, MatcherTestData}
import com.neelnetwork.matcher.model.Events.{OrderAdded, OrderExecuted}
import com.neelnetwork.matcher.model.LimitOrder.{Filled, PartiallyFilled}
import com.neelnetwork.matcher.model.{LimitOrder, OrderHistory}
...
class ReservedBalanceSpecification
  ...
  val pair = AssetPair(mkAssetId("NEEL"), mkAssetId("USD"))
