...
* By default walletDir and dataDir located in $HOME/neel
...
* Upgrade to Neel' Scorex v1.3.1

**0.2.0-RC7**

* New API /neel/payment returns senderPublicKey
* New API /neel/create-signed-payment
* /neel/external-payment deprecated. 
  Use new /neel/broadcast-signed-payment.
* New API /neel/payment/signature
* minimumTxFee verification for API

**0.2.0-RC5**

* /neel/external-payment returns error for incorrect recipient

**0.2.0-RC4**

* Fixed issue with incorrect Handshake
* Balance with confirmations is the minimum balance
* /neel/external-payment returns error if account balance invalid
...
* Upgrade to Scorex 1.2.4. Clean /scorex/neel/data/ before run.
