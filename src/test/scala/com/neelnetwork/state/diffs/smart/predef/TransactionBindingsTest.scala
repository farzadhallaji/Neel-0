...
import com.neelnetwork.lang.ScriptVersion.Versions.V2
import com.neelnetwork.lang.Testing.evaluated
import com.neelnetwork.lang.v1.compiler.CompilerV1
import com.neelnetwork.lang.v1.compiler.Terms.{CONST_BOOLEAN, CONST_LONG, EVALUATED}
...
import com.neelnetwork.state.diffs.ProduceError._
import com.neelnetwork.transaction.assets.exchange.{Order, OrderType}
import com.neelnetwork.transaction.smart.BlockchainContext.In
import com.neelnetwork.transaction.smart.NeelEnvironment
import com.neelnetwork.transaction.{Proofs, ProvenTransaction, VersionedTransaction}
import com.neelnetwork.utils.EmptyBlockchain
...
class TransactionBindingsTest extends PropSpec with PropertyChecks with Matchers with TransactionGen with NoShrink {
  ...
  def runForAsset(script: String): Either[String, EVALUATED] = {
    ...
    import com.neelnetwork.lang.v1.CTX._
    ...
    val ctx =
      PureContext
        ...
        CryptoContext
          .build(Global) |+|
        NeelContext
          .build(V2, new NeelEnvironment(networkByte, Coeval(null), null, EmptyBlockchain), isTokenContext = true)
    ...
    val ctx =
      PureContext.build(V2) |+|
        CryptoContext
          .build(Global) |+|
        NeelContext
          .build(V2, new NeelEnvironment(networkByte, Coeval(t), null, EmptyBlockchain), isTokenContext = false)
