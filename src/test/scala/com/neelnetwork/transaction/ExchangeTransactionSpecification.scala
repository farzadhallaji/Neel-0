...
import com.neelnetwork.transaction.ValidationError.OrderValidationError
import com.neelnetwork.transaction.assets.exchange.{Order, _}
import com.neelnetwork.utils.Base58
import com.neelnetwork.{NTPTime, TransactionGen}
...
class ExchangeTransactionSpecification extends PropSpec with PropertyChecks with Matchers with TransactionGen with NTPTime {
  ...
  property("JSON format validation") {
    ...
    val buy = OrderV1(
      ...
      AssetPair.createAssetPair("NEEL", "9ZDWzK53XT5bixkmMwTJi2YzgxCqn5dUajXFcT2HcFDy").get,
      OrderType.BUY,
      2,
      6000000000L,
      1526992336241L,
