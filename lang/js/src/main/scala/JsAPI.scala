...
import com.neelnetwork.lang.v1.FunctionHeader.{Native, User}
import com.neelnetwork.lang.v1.{Serde, CTX}
...
import com.neelnetwork.lang.v1.traits.{DataType, Environment}
...
object JsAPI {
  ...
  val version = com.neelnetwork.lang.ScriptVersion.Versions.V1

  val neelContext = NeelContext.build(
    version,
    new Environment {
  ...
  val fullContext: CTX = Monoid.combineAll(Seq(PureContext.build(version), cryptoContext, neelContext))
