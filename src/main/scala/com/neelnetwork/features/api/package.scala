package com.neelnetwork.features

import com.neelnetwork.features.BlockchainFeatureStatus.{Activated, Approved, Undefined}
import com.neelnetwork.features.api.NodeFeatureStatus.{Implemented, NotImplemented, Voted}
