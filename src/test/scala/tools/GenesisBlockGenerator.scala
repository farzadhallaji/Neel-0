...
import com.neelnetwork.settings.{GenesisSettings, GenesisTransactionSettings}
import com.neelnetwork.state._
import net.ceedubs.ficus.Ficus._
import net.ceedubs.ficus.readers.ArbitraryTypeReader._
import com.neelnetwork.account.{Address, AddressScheme, PrivateKeyAccount}
...
object GenesisBlockGenerator extends App {
  ...
  com.neelnetwork.account.AddressScheme.current = new AddressScheme {
