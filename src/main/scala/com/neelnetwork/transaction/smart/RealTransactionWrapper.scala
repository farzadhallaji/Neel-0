...
import com.neelnetwork.account.{Address, AddressOrAlias, Alias}
import com.neelnetwork.lang.v1.traits.domain.Tx.{Header, Proven}
import com.neelnetwork.lang.v1.traits.domain._
    ...
    tx match {
      ...
      case ms: MassTransferTransaction =>
        Tx.MassTransfer(
          ...
          transfers = ms.transfers.map(r => com.neelnetwork.lang.v1.traits.domain.Tx.TransferItem(r.address, r.amount)).toIndexedSeq,
