...
import com.neelnetwork.state.{AccountDataInfo, AssetDescription, BalanceSnapshot, Blockchain, ByteStr, DataEntry, Diff, Portfolio, VolumeAndFee}
...
import com.neelnetwork.transaction.{AssetId, Transaction, ValidationError}
...
object EmptyBlockchain extends Blockchain {
  ...
  override def neelDistribution(height: Int): Map[Address, Long] = Map.empty
