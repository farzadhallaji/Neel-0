...
import com.neelnetwork.OrderOps._
import com.neelnetwork.account.{AddressScheme, PrivateKeyAccount}
import com.neelnetwork.features.{BlockchainFeature, BlockchainFeatures}
import com.neelnetwork.lagonaki.mocks.TestBlock
import com.neelnetwork.lang.ScriptVersion.Versions.V1
import com.neelnetwork.lang.directives.DirectiveParser
import com.neelnetwork.lang.v1.ScriptEstimator
import com.neelnetwork.lang.v1.compiler.{CompilerContext, CompilerV1}
import com.neelnetwork.settings.{Constants, FunctionalitySettings, TestFunctionalitySettings}
import com.neelnetwork.state._
import com.neelnetwork.state.diffs.TransactionDiffer.TransactionValidationError
import com.neelnetwork.transaction.ValidationError.AccountBalanceError
import com.neelnetwork.transaction._
import com.neelnetwork.transaction.assets.exchange.{Order, _}
import com.neelnetwork.transaction.assets.{IssueTransaction, IssueTransactionV1, IssueTransactionV2}
...
import com.neelnetwork.transaction.transfer.TransferTransaction
import com.neelnetwork.utils.functionCosts
import com.neelnetwork.{NoShrink, TransactionGen, crypto}
...
class ExchangeTransactionDiffTest extends PropSpec with PropertyChecks with Matchers with TransactionGen with Inside with NoShrink {
  ...
  property("preserves neel invariant, stores match info, rewards matcher") {
  ...
  property("buy neel without enough money for fee") {
  ...
  property("Disable use OrderV1 on SmartAccount") {
    ...
    forAll(for {
      ...
      tr1     = createNeelTransfer(MATCHER, buyer.toAddress, Long.MaxValue / 3, enoughFee, ts + 1).explicitGet()
      tr2     = createNeelTransfer(MATCHER, seller.toAddress, Long.MaxValue / 3, enoughFee, ts + 2).explicitGet()
