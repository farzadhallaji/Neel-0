...
import com.neelnetwork.account.{AddressOrAlias, AddressScheme, PrivateKeyAccount}
import com.neelnetwork.api.http.assets.{SignedIssueV1Request, SignedMassTransferRequest}
import com.neelnetwork.dexgen.cli.ScoptImplicits
import com.neelnetwork.dexgen.config.FicusImplicits
import com.neelnetwork.dexgen.utils.{ApiRequests, GenOrderType}
import com.neelnetwork.it.api.Transaction
import com.neelnetwork.it.util.GlobalTimer
...
import com.neelnetwork.transaction.transfer.MassTransferTransaction
...
object DexGenApp extends App with ScoptImplicits with FicusImplicits with EnumerationReader {
  ...
  val parser = new OptionParser[GeneratorSettings]("generator") {
    head("TransactionsGenerator - Neel load testing transactions generator")
