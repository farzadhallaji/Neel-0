...
import com.neelnetwork.consensus.{GeneratingBalanceProvider, PoSSelector}
import com.neelnetwork.mining._
import com.neelnetwork.network._
import com.neelnetwork.settings.{FunctionalitySettings, NeelSettings}
import com.neelnetwork.utx.UtxPool
import io.netty.channel.Channel
import io.netty.channel.group.ChannelGroup
import monix.eval.Task
import com.neelnetwork.block.Block
import com.neelnetwork.transaction.ValidationError.{BlockAppendError, BlockFromFuture, GenericError}
...
package object appender extends ScorexLogging {
  ...
  private[appender] def appendBlock(checkpoint: CheckpointService,
                                    ...
                                    pos: PoSSelector,
                                    time: Time,
                                    settings: NeelSettings)(block: Block): Either[ValidationError, Option[Int]] =
    for {
      _ <- Either.cond(
  ...
  private def blockConsensusValidation(blockchain: Blockchain, settings: NeelSettings, pos: PoSSelector, currentTs: Long, block: Block)(
